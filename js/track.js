...
var campaignID = "66992f130247370001dcc419";
...
var initialSrc = "https://track.sample-hunters.pro/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("track.sample-hunters.pro/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://track.sample-hunters.pro/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://track.sample-hunters.pro/view?clickid=" + rtkClickID)
        xhrTrack.send();
