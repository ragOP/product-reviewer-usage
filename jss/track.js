...
var campaignID = "667bd5f1eed3c500015c3243";
...
var initialSrc = "https://track.earnoppcenter.pro/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("track.earnoppcenter.pro/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://track.earnoppcenter.pro/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://track.earnoppcenter.pro/view?clickid=" + rtkClickID)
        xhrTrack.send();
